...
<html lang="de">
    ...
    <body class="login-page">
        <header>
            ...
            <button class="login-button" onclick="window.location.href='register.php';">Registrieren</button>
        </header>
            ...
            <div class="login-container">
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password" class="form-control" placeholder="Passwort" oninput="setCustomValidity('')" />
                    </div>
                    <br>
                    <div class="form-group">
        ...
        <footer>
            <section id="contact">
                ...
                <a href="mailto:johann.behling@outlook.com">info@johannbehling.com</a><p>&copy; 2025 Egoinfinitura All rights reserved.</p>
            <ul>
                <li><a href="../public/Impressum.html">Impressum</a></li>
                <li><a href="../public/PrivacyPolicy.html">Datenschutz</a></li>
