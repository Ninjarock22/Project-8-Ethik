...
2. ### Nutzung von MySQL
   ...
   2.2 **Einrichten der Datenbank:**
    ...
    - ⚠️ Aktuell kann es zu einer Fehlermeldung kommen. Diese kann jedoch ignoriert werden. [Weitere Informationen erhalten sie hier](https://github.com/Ninjarock22/Project-8-Ethik/issues/14)
